...
const AllBookingsPage = () => {
  ...
  const logger = useLogger('AllBookingsPage');

  logger.debug('AllBookingsPage rendered');
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Vue globale des réservations de la plateforme</p>
        </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      {booking.guest} • Propriétaire: {booking.owner}
                    </p>
